...
python3 scripts/benchmark.py resume --run-id development-pilot-20260916-revised
python3 scripts/benchmark.py status
python3 scripts/benchmark_report.py report \
  --run-dir ~/.local/share/sekirei-weight2/suisho11beta-v1/runs/development-pilot-20260916-revised \
